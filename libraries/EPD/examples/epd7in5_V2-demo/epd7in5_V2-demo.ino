...
void setup() {
 ...
 DEV_Module_Init();
  ...
  DEV_Delay_ms(500);
    ...
    Paint_NewImage(IMAGE_BW, EPD_7IN5_V2_WIDTH, EPD_7IN5_V2_HEIGHT, IMAGE_ROTATE_0, IMAGE_COLOR_INVERTED);
    Paint_Clear(WHITE);

    //3.Read BMP pictures into RAM
    SDCard_ReadBMP("7in5_V2.bmp", 0, 0);
