...
void setup() {
  DEBUG("5.83inch e-Paper B and C demo\r\n");
  DEV_Module_Init();
  ...
  DEV_Delay_ms(300);
    ...
    //Draw black picture
    DEBUG("IMAGE_BW\n");
    Paint_NewImage(IMAGE_BW, EPD_5IN83BC_WIDTH, EPD_5IN83BC_HEIGHT, IMAGE_ROTATE_0, IMAGE_COLOR_INVERTED);
    Paint_Clear(WHITE);
    //3.Read BMP pictures into RAM
    SDCard_ReadBMP("5in83b-b.bmp", 0, 0);

    //Draw red picture
    DEBUG("IMAGE_BWR\n");
    Paint_NewImage(IMAGE_BWR, EPD_5IN83BC_WIDTH, EPD_5IN83BC_HEIGHT, IMAGE_ROTATE_0, IMAGE_COLOR_INVERTED);
    Paint_Clear(WHITE);
    SDCard_ReadBMP("5in83b-r.bmp", 0, 0);
    ...
    //Draw black picture
    Paint_NewImage(IMAGE_BW, EPD_5IN83BC_WIDTH, EPD_5IN83BC_HEIGHT, IMAGE_ROTATE_0, IMAGE_COLOR_POSITIVE);
    Paint_Clear(WHITE);
    ...
    //Draw red picture
    Paint_NewImage(IMAGE_BWR, EPD_5IN83BC_WIDTH, EPD_5IN83BC_HEIGHT, IMAGE_ROTATE_0, IMAGE_COLOR_POSITIVE);
    Paint_Clear(WHITE);
