...
void setup() {
  ...
  DEV_Delay_ms(100);
    ...
    //Draw black picture
    DEBUG("IMAGE_BW\n");
    Paint_NewImage(IMAGE_BW, EPD_2IN66_WIDTH, EPD_2IN66_HEIGHT, IMAGE_ROTATE_0, IMAGE_COLOR_POSITIVE);
    Paint_Clear(WHITE);
    
    //3.Read BMP pictures into RAM
    SDCard_ReadBMP("2in66.bmp", 0, 0);
...
#if 0
  DEBUG("Draw picture\r\n");
  Paint_NewImage(IMAGE_BW, EPD_2IN66_WIDTH, EPD_2IN66_HEIGHT, IMAGE_ROTATE_90, IMAGE_COLOR_POSITIVE);
  Paint_Clear(WHITE);
...
#if 1
    EPD_2IN66_Init_Partial();       //init Partial fresh mode
    EPD_2IN66_Clear();
    
    Paint_NewImage(IMAGE_BW, EPD_2IN66_WIDTH, EPD_2IN66_HEIGHT, IMAGE_ROTATE_90, IMAGE_COLOR_POSITIVE);
    Paint_Clear(WHITE);
    
    DEBUG("show time, partial update, just Partial mode\r\n");
