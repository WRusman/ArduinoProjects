...
void setup() {
	...
	Paint_NewImage(IMAGE_BW, EPD_2IN13_WIDTH, EPD_2IN13_HEIGHT, IMAGE_ROTATE_0, IMAGE_COLOR_POSITIVE);
	Paint_Clear(WHITE);
	...
	Paint_NewImage(IMAGE_BW, EPD_2in13_V3_WIDTH, EPD_2in13_V3_HEIGHT, IMAGE_ROTATE_0, IMAGE_COLOR_POSITIVE);
	Paint_Clear(WHITE);		
...
#elif 0
    //1.Create a new image cache named IMAGE_BW and fill it with white
	UBYTE Rotate = IMAGE_ROTATE_0;
	Paint_NewImage(IMAGE_BW, EPD_2in13_V3_WIDTH, EPD_2in13_V3_HEIGHT, Rotate, IMAGE_COLOR_POSITIVE);
	Paint_Clear(WHITE);
