...
void setup() {
    ...
    printf("2.7inch e-Paper B V2 demo\r\n");
    EPD_2IN7B_V2_Init();
    ...
    //Draw black image
    printf("IMAGE_BW\n");
    Paint_NewImage(IMAGE_BW, EPD_2IN7B_V2_WIDTH, EPD_2IN7B_V2_HEIGHT, IMAGE_ROTATE_0, IMAGE_COLOR_POSITIVE);
    Paint_Clear(WHITE);
    //3.Read BMP images into RAM
    SDCard_ReadBMP("2in7bV2b.bmp", 0, 0);

    //Draw red image
    printf("IMAGE_BWR\n");
    Paint_NewImage(IMAGE_BWR, EPD_2IN7B_V2_WIDTH, EPD_2IN7B_V2_HEIGHT, IMAGE_ROTATE_0, IMAGE_COLOR_POSITIVE);
    Paint_Clear(WHITE);
    SDCard_ReadBMP("2in7bV2r.bmp", 0, 0);

    //4.Refresh the picture in RAM to e-Paper
    EPD_2IN7B_V2_Display();
    DEV_Delay_ms(2000);
#elif 0
    ...
    /*Horizontal screen*/
    //1.Draw black image
    Paint_NewImage(IMAGE_BW, EPD_2IN7B_V2_WIDTH, EPD_2IN7B_V2_HEIGHT, IMAGE_ROTATE_90, IMAGE_COLOR_POSITIVE);
    Paint_Clear(WHITE);
    ...
    //2.Draw red image
    Paint_NewImage(IMAGE_BWR, EPD_2IN7B_V2_WIDTH, EPD_2IN7B_V2_HEIGHT, IMAGE_ROTATE_90, IMAGE_COLOR_POSITIVE);
    Paint_Clear(WHITE);
