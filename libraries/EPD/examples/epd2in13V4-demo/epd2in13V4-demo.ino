...
void setup() {
  ...
  Paint_NewImage(IMAGE_BW, EPD_2in13_V4_WIDTH, EPD_2in13_V4_HEIGHT, IMAGE_ROTATE_0, IMAGE_COLOR_POSITIVE);
  Paint_Clear(WHITE);   
...
//  SPIRAM_Usertest();
  ...
  Paint_NewImage(IMAGE_BW, EPD_2in13_V4_WIDTH, EPD_2in13_V4_HEIGHT, Rotate, IMAGE_COLOR_POSITIVE);
  Paint_Clear(WHITE);
