...
DEBUG("2.9inch e-Paper demo\r\n");
  ...
  DEV_Delay_ms(500);
    ...
    Paint_NewImage(IMAGE_BW, EPD_2IN9_WIDTH, EPD_2IN9_HEIGHT, IMAGE_ROTATE_0, IMAGE_COLOR_POSITIVE);
    Paint_Clear(WHITE);
...
#if 0
    //1.Create a new image cache named IMAGE_BW and fill it with white
    Paint_NewImage(IMAGE_BW, EPD_2IN9_WIDTH, EPD_2IN9_HEIGHT, Rotate, IMAGE_COLOR_POSITIVE);
    Paint_Clear(WHITE);
...
//      UBYTE Rotate = IMAGE_ROTATE_90;
    Paint_NewImage(IMAGE_BW, EPD_2IN9_WIDTH, EPD_2IN9_HEIGHT, IMAGE_ROTATE_90, IMAGE_COLOR_POSITIVE);
    Paint_Clear(WHITE);
