...
void setup() {
  DEBUG("2.13inch e-Paper B V3 demo\r\n");
  DEV_Module_Init();
  EPD_2IN13B_V3_Init();
  EPD_2IN13B_V3_Clear();
  DEV_Delay_ms(100);
    ...
    //Draw black image
    DEBUG("IMAGE_BW\n");
    Paint_NewImage(IMAGE_BW, EPD_2IN13B_V3_WIDTH, EPD_2IN13B_V3_HEIGHT, IMAGE_ROTATE_0, IMAGE_COLOR_POSITIVE);
    Paint_Clear(WHITE);
    //3.Read BMP images into RAM
    SDCard_ReadBMP("2in13bb.bmp", 0, 0);
  
    //Draw red image
    DEBUG("IMAGE_BWR\n");
    Paint_NewImage(IMAGE_BWR, EPD_2IN13B_V3_WIDTH, EPD_2IN13B_V3_HEIGHT, IMAGE_ROTATE_0, IMAGE_COLOR_POSITIVE);
    Paint_Clear(WHITE);
    SDCard_ReadBMP("2in13br.bmp", 0, 0);

    //4.Refresh the image in RAM to e-Paper
    EPD_2IN13B_V3_Display();
    DEV_Delay_ms(4000);  
#elif 1
    ...
    Paint_NewImage(IMAGE_BW, EPD_2IN13B_V3_WIDTH, EPD_2IN13B_V3_HEIGHT, IMAGE_ROTATE_90, IMAGE_COLOR_POSITIVE);
    Paint_Clear(WHITE);
    ...
    Paint_NewImage(IMAGE_BWR, EPD_2IN13B_V3_WIDTH, EPD_2IN13B_V3_HEIGHT, IMAGE_ROTATE_90, IMAGE_COLOR_POSITIVE);
    Paint_Clear(WHITE);
