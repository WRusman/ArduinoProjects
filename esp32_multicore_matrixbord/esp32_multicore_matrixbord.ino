...
Ticker timer1(display1Thread,1000); // every 100ms
Ticker timer2(display2Thread,1500); // every 100ms
//Ticker timer3(display3Thread,2000); // every 100ms
//Ticker timer4(display4Thread,2500); // every 100ms
//Ticker timer5(display5Thread,3000); // every 100ms
//Ticker timer6(display6Thread,2500); // every 100ms
//Ticker timer7(display7Thread,2000); // every 100ms
//Ticker timer8(display8Thread,1500); // every 100ms
//Ticker timer9(blinkLedThread,500); // every half second
